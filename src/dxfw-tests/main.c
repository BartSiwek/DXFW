...
int main() {
  const struct CMUnitTest tests[] = {
    ...
    cmocka_unit_test_setup_teardown(dxfwWindowSizeChangedTest, dxfwSingleWindowTestSetup, dxfwSingleWindowTestTeardown),
    cmocka_unit_test_setup_teardown(dxfwWindowMinimizedTest, dxfwSingleWindowTestSetup, dxfwSingleWindowTestTeardown),
    cmocka_unit_test_setup_teardown(dxfwWindowMaxShowTest, dxfwSingleWindowTestSetup, dxfwSingleWindowTestTeardown),
    cmocka_unit_test_setup_teardown(dxfwWindowMaximizedTest, dxfwSingleWindowTestSetup, dxfwSingleWindowTestTeardown),
    cmocka_unit_test_setup_teardown(dxfwWindowMaxHideTest, dxfwSingleWindowTestSetup, dxfwSingleWindowTestTeardown),
    cmocka_unit_test_setup_teardown(dxfwSizeChangedCallbackNullWindowTest, dxfwInitializedTestSetup, dxfwInitializedTestTeardown),
